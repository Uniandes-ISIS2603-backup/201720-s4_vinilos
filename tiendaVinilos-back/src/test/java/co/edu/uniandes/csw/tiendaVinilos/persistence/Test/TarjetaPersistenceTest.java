...
public class TarjetaPersistenceTest {
    ...
    public static JavaArchive createDeployment() {
        return ShrinkWrap.create(JavaArchive.class).addPackage(TarjetaEntity.class.getPackage()).addPackage(
            TarjetaPersistence.class.getPackage()).addAsManifestResource(
...
//      ArrayList<TarjetaEntity> ar = (ArrayList<TarjetaEntity>) list;
        ...
        for (Object ent : list) {
            ...
            for (TarjetaEntity entity : data) {
                if (((TarjetaEntity) ent).getId().equals(entity.getId())) {
                    existe = true;
                }
            }

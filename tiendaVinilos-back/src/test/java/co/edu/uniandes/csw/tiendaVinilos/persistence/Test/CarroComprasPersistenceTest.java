...
public class CarroComprasPersistenceTest {
    ...
    public static JavaArchive createDeployment() {
        return ShrinkWrap.create(JavaArchive.class).addPackage(CarroComprasEntity.class.getPackage()).addPackage(
            CarroComprasPersistence.class.getPackage()).addAsManifestResource(

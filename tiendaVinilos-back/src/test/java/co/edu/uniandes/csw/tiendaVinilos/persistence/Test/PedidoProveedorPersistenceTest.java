...
public class PedidoProveedorPersistenceTest {
    ...
    public static JavaArchive createDeployment() {
        return ShrinkWrap.create(JavaArchive.class).addPackage(PedidoProveedorEntity.class.getPackage()).addPackage(
            PedidoProveedorPersistence.class.getPackage()).addAsManifestResource(

...
public class PagoClienteLogic {
    ...
    private static final Logger LOGGER = Logger.getLogger(PagoClienteLogic.class.getName());
     ...
     @Inject
    PagoClientePersistence persistence;
     @Inject
    PedidoClientePersistence persistencePedido;
    ...
    public PagoClienteEntity createPago(Long idPedido, PagoClienteEntity entity) throws BusinessLogicException {
        ...
        persistencePedido.update(pedido);
     ...
     */
    public PagoClienteEntity updatePago(Long idPedido, Long idPago, PagoClienteEntity entity) throws BusinessLogicException {

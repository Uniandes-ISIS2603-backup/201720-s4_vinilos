...
public class ProveedorVinilosResource {
    ...
    public ViniloDetailDTO getVinilo(@PathParam("idProveedor") Long idProv, @PathParam("idVin") Long idVin)
        ...
        if (vinDTO == null) {
            throw new BusinessLogicException("No existe el vinilo con id " + idVin
                                             + " perteneciente al proveedor con id " + idProv);
        }
    ...
    @POST
    public ViniloDetailDTO createVinilo(ViniloDetailDTO vinilo, @PathParam("idProveedor") Long idProv)
            throws BusinessLogicException {

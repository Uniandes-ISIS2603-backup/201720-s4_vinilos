...
public class PedidoClienteResource {
    ...
    @PUT
    @Path("{id: \\d+}")
    public PedidoClienteDetailDTO cancelPedido(@PathParam("id") Long id, PedidoClienteDetailDTO pedido) throws BusinessLogicException {
        
        pedido.setId(id);
        return new PedidoClienteDetailDTO(pedidoLogic.cancelPedido(id, pedido.toEntity()));
    }
    ...
    @PUT
    @Path("{id: \\d+}")
    public PedidoClienteDetailDTO updateEstadoPedido(@PathParam("id") Long id, PedidoClienteDetailDTO pedido) throws BusinessLogicException {
    ...
    @PUT
    @Path("{id: \\d+}")
    public PedidoClienteDetailDTO updateInfoPedido(@PathParam("id") Long id, PedidoClienteDetailDTO pedido) throws BusinessLogicException {
        
        pedido.setId(id);
        return new PedidoClienteDetailDTO(pedidoLogic.updateInfoPedido(id, pedido.toEntity()));
    }
